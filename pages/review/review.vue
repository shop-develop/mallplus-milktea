	...
	export default {
		...
		methods: {
			 async submit() {
				...
				let stars = this.form.score_service +','+this.form.score_order +','+this.form.score_speed +','+this.form.score_product +','+this.form.score_enviroment;
				let params = { storeId: 1,memo:this.form.opinion,pic:stars,star:this.form.score_service };
